...
// A minimal Input → LLM → Output flow so the canvas opens with something to
// explore rather than a blank grid. Seeded inside editor.untracked() so it
// stays out of the undo history; with localStorage persistence it's just the
// starting point — your edits replace it.
